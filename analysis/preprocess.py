...
class LeetAnalysis(webdriver.Chrome):
    ...
    def __init__(self, teardown=False):
        ...
        self.ques_link_list = []
        self.df = None
        self.username = "Anushk97"
        self.password = "Lancaster2018%"
    ...
    def login(self):
        try:
            ...
            login_input.send_keys(self.username)  # Passing username
            self.implicitly_wait(10)
            pass_input.send_keys(self.password)  # Passing password
            ...
            print("Already Logged In or element not found")

        # # Now I am at my home page where I now need to go to my profile pic button and then click on submission
        # try:
        #     # Wait for the account button to be present
        #     WebDriverWait(self, 20).until(
        #         EC.presence_of_element_located((By.CSS_SELECTOR, 'button#headlessui-menu-button-:r4'))
        #     )
        #     account_btn = self.find_element(By.CSS_SELECTOR, 'button#headlessui-menu-button-:r4')
        #     account_btn.click()
    ...
    def scrap_submission_page(self):
        ...
        while condition:
            ...
            try:
                question_table = WebDriverWait(self, 20).until(
                    EC.presence_of_element_located((By.XPATH, '//*[@id="submission-list-app"]/div/table'))
                )
            except TimeoutException:
                print("Loading took too much time or element not found")
                continue
